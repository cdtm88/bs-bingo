...
<div class="flex flex-col gap-3">
  <div class="relative pt-5">
    {#each [{ tier: "3\u00d73", threshold: TIER_THRESHOLDS["3x3"] }, { tier: "4\u00d74", threshold: TIER_THRESHOLDS["4x4"] }, { tier: "5\u00d75", threshold: TIER_THRESHOLDS["5x5"] }] as marker}
      <span
        class="absolute top-0 text-xs text-[var(--color-ink-secondary)] -translate-x-1/2"
        style="left: {(marker.threshold / TIER_THRESHOLDS['5x5']) * 100}%"
      >
        {marker.tier}
      </span>
    {/each}
