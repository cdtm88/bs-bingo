 ...
 *
 * Dev workflow: `pnpm build` runs this automatically as part of the "build" script in package.json.
...
const patched = `// AUTO-GENERATED + PATCHED — do not edit directly. See scripts/patch-worker.mjs.
${stripped}
